...
- **Nível A:** 1.4.1 Uso de cores (marcador do slide ativo diferenciado apenas pela cor de fundo) e 2.2.2 Pausar, Parar, Ocultar (banner rotativo com avanço automático a cada 4 segundos, sem mecanismo de pausa).
- **Nível AA:** 1.4.3 Contraste mínimo (4 reprovações confirmadas por amostragem de pixels, a pior em 1,66:1); 1.4.10 Reflow (conteúdo de 330 px em tela de 320 px, gerando rolagem horizontal); 1.4.11 Contraste não textual (indicador de foco em 1,56:1 sobre o fundo branco do conteúdo); 1.4.12 Espaçamento de texto (rolagem horizontal e 3 elementos cortados); 2.5.8 Tamanho do alvo (23 dos 51 alvos interativos da versão móvel medem menos de 24x24 px).
...
| Contraste por pixel | 4 reprovações confirmadas · pior 1,66:1 |
...
| Barra do Governo Federal (barra.brasil.gov.br) | 4,0:1 | 4,5:1 |
...
6. **[Alta]** Rolagem horizontal em telas estreitas — WCAG 1.4.10 (AA)
7. **[Média]** Indicador de foco pouco perceptível sobre fundo branco — WCAG 1.4.11 (AA)
8. **[Média]** Alvos de toque abaixo do mínimo — WCAG 2.5.8 (AA)
9. **[Média]** Layout quebra com espaçamento de texto ampliado — WCAG 1.4.12 (AA)
10. **[Média]** Texto alternativo redundante — WCAG 1.1.1 (A)
11. **[Baixa]** URL crua como texto de link — WCAG 2.4.4 (A)
12. **[Baixa]** Página de Acessibilidade desatualizada — eMAG 3.1 / WCAG 2.4.5

## Cuidado: quatro coisas que o deck NÃO deve dizer
...
| `08-reflow-320px.png` | a rolagem horizontal em 320 px |
